...
button2.onclick=()=>{
    if(red.checked){
        redImage.classList.add("hidden")
        redImage.classList.remove("eject")
    }
    if(blue.checked){
        blueImage.classList.add("hidden")
        blueImage.classList.remove("eject")
    }
    if(yellow.checked){
        yellowImage.classList.add("hidden")
        yellowImage.classList.remove("eject")
    }
}